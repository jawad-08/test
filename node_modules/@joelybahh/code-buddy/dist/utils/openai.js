...
import { CommitMessageError, ConfigLoadError } from "../types/index.js";
...
export function loadConfig() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const config = yield import(path.resolve(process.cwd(), "cb.config.js"));
...
const extractFunctionArgs = (response) => {
 ...
 */
export function determineCommitMessage(diff, scope, type, reason) {
    return __awaiter(this, void 0, void 0, function* () {
        const [openai, config] = yield getOpenAI();
        ...
        try {
                ...
                functions: [
                    {
                        ...
                        description: "A function to structure a commit message based on changes and user context.",
                        parameters: {
                            type: "object",
                            properties: {
                                summary: {
                                    type: "string",
                                    description: "A concise summary of the changes to be committed, no longer than 100 words",
                                },
                                description: {
                                    type: "string",
                                    description: "A more detailed description of the changes to be committed as dot points, no longer than 200 words",
                                },
                                type: {
                                    type: "string",
                                    enum: [
            ...
            return createMessage(Object.assign({ scope }, args));
        }
        catch (error) {
...
const createMessage = ({ scope, summary, description, type, }) => {
    if (scope === ".")
        return `${type}: ${summary} \n\n${description}`;
...
const getCommitMessagePrompt = (diff, scope, type, reason) => {
